...
-Djava.security.auth.login.config=C:\km\kafka\kerberos\rt.jaas
-Djava.security.krb5.conf=C:\km\kafka\kerberos\krb5.conf
---------


#Run/Debug Configurations (Edit Configurations..)
-Djava.security.auth.login.config=C:\km\kerberos\rtalab_vision\rt.jaas -Djava.security.krb5.conf=C:\km\kerberos\krb5.conf -Djavax.security.auth.useSubjectCredsOnly=false
