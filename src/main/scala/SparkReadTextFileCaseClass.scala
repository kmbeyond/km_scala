...
object SparkReadTextFileCaseClass {
  ...
  case class CustSurvey(age: Int,
                        job: String,
                        marital: String,
                        education: String,
                        default0: String,
                        balance: Float, housing: String, loan: String, contcat: String,
                        day: Int, month: String, duration: Int,
                        campaign: Int, pdays: Int,
                        previous: Int, poutcome: String, y: String)


  def main(args: Array[String]) {

    val filepath = "/home/kiran/km/km_big_data/Projects_praveen_r/Projects/BDHS_Projects/Project for submission/Project 1/Project 1_dataset_bank-full (2).csv"
...
*/
    ...
    val linesRDD = sc.textFile(filepath).
      map(x=>x.substring(1,x.size-1).split(';')).
