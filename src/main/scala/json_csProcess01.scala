...
*/
    ...
    df_cs_request.repartition(1).write.insertInto(sDBName+".cs_request")
    ...
    df_cs_request_merchant.repartition(1).write.insertInto(sDBName+".cs_request_merchant")
    ...
    df_cs_request_audience.repartition(1).write.insertInto(sDBName+".cs_request_audience")
    run_time_ts = new java.text.SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS").format(new java.util.Date())
